...
<body>
    ...
    <div class="items_grid">
        ...
        $result = mysqli_fetch_all(mysqli_query($connect, "SELECT * FROM `promo`"));

        foreach ($result as $promo) {
            echo '
            <a href="/php/new.php?id='.$promo[0].'">
                <div class="uslitem sale">
                    
                    <div style="background-image: url('.$promo[4].')" class="image">
                    </div>
